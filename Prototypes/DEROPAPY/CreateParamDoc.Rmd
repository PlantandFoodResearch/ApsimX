...
for(i in 1:length(cats)) {
 ...
 # filter(ParamName == select_param) %>%
  ...
  ggsave(filename = file.path(save_path,paste0(cats[i],".jpg")), dpi=100 )
...
ggplot(aes(x = `Axis_X`, y = `Axis_Y`)) +
  ...
  facet_wrap(Category ~ ParamNameFull, scales = "free", ncol=2) +
  ...
  ggsave(filename = file.path(save_path,paste0(paste0("Array_",cats[i]),".jpg")), dpi=100 )
