...
ggplot(aes(x = TimeSliceYear)) +
 ...
 facet_wrap(~Crop, scales = 'free', ncol=4) +
  ...
  labs(
    caption = "Fig.1S: Range of median yield changes estimated along three selected Representative Concentration\n Pathways (RCP4.5, RCP6.0 and RCP8.5) pooled within New Zealand regions across ~5km grid-cells \nwith three most prevalent soils, two water regimes (irrigated and rainfed) and\n considering five General Circulation Models (GCMs)"
